...
class HandleCollisionsAction(Action):
    ...
    def _handle_segment_collision(self, cast):
        ...
        #This code handles collisions between snakes and eating the other ones food, if so Game Over.
        for segment2 in segments2:
            for segment in segments:
                if head.get_position().equals(segment.get_position()):
                    self._is_game_over = True
                 
                elif head.getposition().equals(segment2.get_position()):
                    self._is_game_over = True
                   
                if head2.get_position().equals(segment2.get_position()):
                    self._is_game_over = True
                    
                elif head2.get_postion().equals(segment.get_position()):    
                      self._is_game_over = True
    ...
    def _handle_game_over(self, cast):
        ...
        if self._is_game_over:
            ...
            food = cast.get_first_actor("foods")
            food2 = cast.get_first_actor("foods")
            snake2 = cast.get_first_actor("snakes2")
